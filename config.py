...
PDF_FOLDER_PATH = os.path.join(os.path.expanduser("~"), "AI Internship Task Wasserstoff", "dataset")  # Change this path if needed

# Logging Configuration
LOG_FILE_PATH = os.path.join(os.path.expanduser("~"), "AI Internship Task Wasserstoff", "logs", "app.log")  # Path for log files
